...
const AnnounceAddEnForm = () => {
  ...
  const onCreate = async (e) => {
    ...
    if (window.confirm('등록 하시겠습니까?')) {
      const newList = { boardId: 'EN_ANN', boardTitle: boardTitle, boardContents: boardContents, files: files };
      await dispatch(insertBoard(newList));
      return navigate('/admin/investInfo/announceEn');
    }
  };
    ...
    <div className="a-content">
      ...
      <div className="ban-list bg-white">
        <div className="btn-area position">
          <NavLink to="/admin/investInfo/announceEn">
...
export default AnnounceAddEnForm;
