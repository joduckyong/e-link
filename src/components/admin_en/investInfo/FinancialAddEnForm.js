...
const FinancialAddEnForm = (props) => {
  ...
  const onCreate = async (e) => {
    ...
    if (window.confirm('등록 하시겠습니까?')) {
      const newList = { boardId: 'EN_FIN', boardTitle: boardTitle, boardContents: boardContents, files: files };
      await dispatch(insertBoard(newList));
      return navigate('/admin/investInfo/financialEn');
    }
  };
...
export default FinancialAddEnForm;
