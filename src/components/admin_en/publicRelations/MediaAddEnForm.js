...
const MediaAddEnForm = () => {
  ...
  const onCreate = async (e) => {
    ...
    if (window.confirm('등록 하시겠습니까?')) {
      const newList = { boardId: 'EN_MED', boardTitle: boardTitle, boardContents: boardContents, url: url, thumbnail: thumbnailObj, files: files };
      await dispatch(insertBoard(newList));
      return navigate('/admin/publicRelations/mediaEn');
    }
  };
    ...
    <div className="a-content">
      ...
      <div className="ban-list bg-white">
        <div className="btn-area position">
          <Link to="/admin/publicRelations/mediaEn">
