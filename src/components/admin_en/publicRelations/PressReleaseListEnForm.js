...
const PressReleaseListEnForm = () => {
  ...
  useEffect(() => {
    const newList = { boardId: 'EN_PRE', pageIndex: page };
    ...
    <div className="a-content">
      ...
      <div className="ban-list p0">
        <div className="btn-area position">
          ...
          <Link to="/admin/publicRelations/pressReleaseAddEn">
              ...
              {boardList.map((list, index) => (
                <tr key={index}>
                  ...
                  <td className="tal pl40">
                    <Link to={`/admin/publicRelations/pressReleaseInfoEn/${list.boardId}`}>
                  ...
                  <td>
                    <Link to={`/admin/publicRelations/pressReleaseModEn/${list.boardId}`}>
...
export default PressReleaseListEnForm;
