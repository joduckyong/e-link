...
const PressReleaseAddEnForm = () => {
  ...
  const onCreate = async (e) => {
    ...
    if (window.confirm('등록 하시겠습니까?')) {
      const newList = { boardId: 'EN_PRE', boardTitle: boardTitle, boardContents: boardContents, thumbnail: thumbnailObj, files: files };
      await dispatch(insertBoard(newList));
      return navigate('/admin/publicRelations/pressReleaseEn');
    }
  };
...
export default PressReleaseAddEnForm;
