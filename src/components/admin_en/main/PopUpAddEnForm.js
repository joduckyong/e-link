...
import { insertPopup } from 'store/popupEnReducer';
...
const PopUpAddEnForm = () => {
  ...
  const onCreate = async (e) => {
    ...
    if (window.confirm('등록 하시겠습니까?')) {
      ...
      return navigate('/admin/main/popupEn');
    }
  };
          ...
          <div className="popimg-area">
            ...
            <div className="img-in">
              ...
              <span className="upload-name">
                {thumbnailName !== undefined && <img src={thumbnailName} alt="" style={{ width: '220px', height: '240px' }} />}
              </span>
            </div>
