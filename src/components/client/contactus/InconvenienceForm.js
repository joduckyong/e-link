          ...
          <div className="agree-detail-wp">
            ...
            >
              ...
              <p className="depth02_p">
                ...
                <br />⑥ 「통신비밀보호법」에 따른 서비스이용기록, 접속로그,
                접속IP정보 : 3개월 3) 회사는 개인위치정보의 이용•제공 사실 확인
                자료를 『위치정보의 보호 및 이용 등에 관한 법률』 제16조 제2항에
              ...
              <p className="depth02_p">
                ...
                하고 있습니다. <br />
                ② 통신 구간 암호화 홈페이지를 통한 회원가입 및 로그인 등
                고객정보를 입력하여 전달하는 구간에 대해 SSL 등 암호화 통신을
                통하여 고객의 정보가 안전하게 전송되도록 조치하고 있습니다.{' '}
                <br />③ 보안솔루션의 설치 서비스 제공 및 고객의 정보를 안전하게
                관리하기 위하여 개인정보처리시스템에 대해 백신프로그램의 설치,
                주기적인 업데이트 및 정기점검을 수행하고 있으며, DB 접근제어
                솔루션 및 필요시 화면캡처방지 솔루션 등을 적용하고 있습니다.
              </p>
              <h4>2) 관리적 조치 </h4>
              <p className="depth02_p">
