          ...
          <ul className="path" data-aos="fade-up" data-aos-duration="2000" data-aos-once="true" data-aos-delay="200">
            ...
            <li className={classnames('on link', { show: activeMenu2 })}>
              ...
              <ul className={classnames('links', { active: activeMenu2 })}>
                ...
                <li>
                  <NavLink to="/recruit/benefits" className="on">
                    복리후생
                  </NavLink>
                </li>
                <li>
      ...
      <div className="content pb0">
        <div className="wrap">
          <h3 data-aos="fade-right" data-aos-duration="2000" data-aos-once="true">
            LS E-Link는 밝고 자유로운 기업 문화 아래
            <br />
            다양한 복리후생 제도를 통해 구성원의 행복한 삶을 지원하고 있습니다.
          </h3>
          ...
          <ul className="welfare">
            <li data-aos="fade-up" data-aos-duration="2000" data-aos-once="true">
              <div className="img">
                <span>
                  <img src="../../img/sub/ico-house.svg" alt="" />
                </span>
              </div>
              <div className="txt">
            ...
            <li data-aos="fade-up" data-aos-duration="2000" data-aos-once="true">
              <div className="img">
                <span>
                  <img src="../../img/sub/ico-hat.svg" alt="" />
                </span>
              </div>
              <div className="txt">
            ...
            <li data-aos="fade-up" data-aos-duration="2000" data-aos-once="true">
              <div className="img">
                <span>
                  <img src="../../img/sub/ico-love.svg" alt="" />
                </span>
              </div>
              <div className="txt">
            ...
            <li data-aos="fade-up" data-aos-duration="2000" data-aos-once="true">
              <div className="img">
                <span>
                  <img src="../../img/sub/ico-medical.svg" alt="" />
                </span>
              </div>
              <div className="txt">
            ...
            <li data-aos="fade-up" data-aos-duration="2000" data-aos-once="true">
              <div className="img">
                <span>
                  <img src="../../img/sub/ico-tree.svg" alt="" />
                </span>
              </div>
              <div className="txt">
            ...
            <li data-aos="fade-up" data-aos-duration="2000" data-aos-once="true">
              <div className="img">
                <span>
                  <img src="../../img/sub/ico-gift.svg" alt="" />
                </span>
              </div>
              <div className="txt">
        ...
        <div className="hire">
          ...
          <div className="wrap">
            <p data-aos="fade-right" data-aos-duration="2000" data-aos-once="true">
              현재 진행중인 채용공고를 확인해 보세요.
            </p>
            <NavLink to="/recruit/posting" data-aos="flip-left" data-aos-duration="2000" data-aos-once="true" data-aos-delay="200">
              채용공고 보기
            </NavLink>
          </div>
        </div>
