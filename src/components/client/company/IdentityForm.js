...
import { zipDownloadFile } from 'common/download';
import AOS from 'aos';
          ...
          <div className="ci-wrap">
            <div className="wrap">
              ...
              <p className="ci-introduce2" data-aos="fade-right" data-aos-duration="2000" data-aos-once="true">
                ...
                <button className="btn-down" onClick={() => zipDownloadFile('CI.zip', 'CI.zip')}>
                  다운로드
                </button>
              </p>
              <div className="represt">
          ...
          <div className="ci-wrap bg-gray">
            <div className="wrap">
              ...
              <p className="ci-introduce2" data-aos="fade-right" data-aos-duration="2000" data-aos-once="true">
                ...
                <button className="btn-down" onClick={() => zipDownloadFile('Wordmark.zip', 'Wordmark.zip')}>
                  다운로드
                </button>
              </p>
