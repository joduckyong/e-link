          ...
          <div className="company-infor">
            ...
            <div className="txt">
              <div
                ...
                data-aos-once="true"
              >
                LS E-Link는 전기·전력분야의 글로벌 리딩 기업군을 이끌고 있는
                ㈜LS와 친환경 에너지 선도기업 ㈜E1이 전기화(Electrification)시대
                전기차량(EV) 충전인프라 구축 및 운영서비스를 위해 함께 설립한
                회사입니다.
              </div>
              <p
                data-aos="fade-up"
                ...
                data-aos-once="true"
              >
                세계는 지금 탄소제로시대를 향한 위대한 여정 가운데 있습니다.
                전기차량을 비롯한 친환경 차량들이 내연기관차의 자리를 빠르게
                대체해 갈 것입니다. 차량보급 속도만큼 편리하고 안전한 충전환경,
                사용환경을 조성하는 일도 중요한 과제입니다. ‘전기를 잘 아는
                기업’ LS와 ‘에너지 사용자의 마음을 누구보다 잘 아는 기업’ E1의
                역량을 모아 세계 최고수준의 전기 충전 솔루션을 만들어
                가겠습니다. 특히, 전기차량 충전을 위해 대용량의 전기를 사용하게
                될 운수, 물류기업들에게 LS E-Link는 최고의 파트너가 되리라
                확신합니다.
                <strong>
                  ‘함께 하여 더 큰 가치를’ 만들어 가는 LS E-Link가 되겠습니다.
                </strong>
              </p>
            </div>
          </div>
