...
const JobVacancyModEnForm = () => {
  ...
  const onEdit = async (e) => {
    ...
    if (window.confirm('수정 하시겠습니까?')) {
      ...
      return navigate('/admin/employmentInfo/jobVacancyEn');
    }
  };
        ...
        <div className="edit">
          ...
          <div className="pop-show" style={{ marginBottom: 20 }}>
            ...
            <span style={{ width: '40%' }}>
              <DatePicker
                ...
                showTimeSelect
                selected={boardStartDatetime}
                onChange={(date) => setBoardStartDatetime(date)}
              />
            </span>
            -
            <span style={{ width: '40%' }}>
              <DatePicker
                ...
                dateFormat="yyyy-MM-dd HH:mm:ss"
                showTimeSelect
                selected={boardEndDatetime}
                onChange={(date) => setBoardEndDatetime(date)}
              />
            </span>
          </div>
          ...
          <div className="ed-file">
            ...
            <div className="file-area">
              ...
              />
              <Link to="" className="btn-add" onClick={onAddFileBox}>
...
export default JobVacancyModEnForm;
