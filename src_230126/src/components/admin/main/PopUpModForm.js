      ...
      <div className="ban-list bg-white">
        ...
        <div className="pop-in">
          <div className="popimg-area">
            ...
            <div className="img-in active">
              <div className="img-position">
                <img src="" alt="" id="img" />
              </div>
              <label htmlFor="idvf">
                <span  style={{ color: '#fff' }}>
                  <i style={{ background: 'url("/img/admin/ico-upload-on.png") center / 31px' }}></i>
                  이미지등록
                  <input type="file" accept="image/*" id="idvf" name="u_file" className="file" ref={thumbnailRef} onChange={onUploadImage} />
                </span>
              </label>
              {imgCheck ? (
                <span className="imgBox active">
					<img src={thumbnailName} alt="" style={{ width: '236px', height: '263px', position: 'absolute', top: '0', left: '0' }} />
				</span>
              ) : (
